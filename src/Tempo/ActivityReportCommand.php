...
class ActivityReportCommand extends Command
{
    ...
    {
        $worklogApi = new WorklogForUser($_SERVER['TEMPO_ENDPOINT'], $_SERVER['TOKEN']);
        ...
        $results = [];
        $page = 1;
        $this->account = $accountApi->get(44);
    ...
    protected function mapResults(array $result): array
    {
        ...
        $parsedResult = [
            ...
            "External Jira Key" => $issue['fields']['customfield_10118'],
            "External Jira Epic" => $issue['fields']['customfield_10123'],
            "External Jira Id" => $issue['fields']['customfield_10124'],
